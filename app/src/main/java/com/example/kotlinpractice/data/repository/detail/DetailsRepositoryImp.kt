...
import com.example.kotlinpractice.data.mapper.QuoteDetailsMapper
...
class DetailsRepositoryImp @Inject constructor(private val apiService: APiService):DetailsRepository {
    override suspend fun getQuoteById(id:String): QuoteDetailsModel {
        val details=apiService.getQuoteById(id)
       return QuoteDetailsMapper.mapDetailsToUi(details)
    }
}